module github.com/loft-sh/dockerless
...
require (
	...
	github.com/gokrazy/rsync v0.2.2
...
replace github.com/GoogleContainerTools/kaniko => github.com/loft-sh/kaniko v0.0.0-20230829085832-728f37171854
